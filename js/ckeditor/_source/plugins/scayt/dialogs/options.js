					...
					elements : [
						{
							type : 'html',
							id : 'options',
							html : 	'<form enctype="multipart/form-data" name="optionsbar_' + editorName + '"><div class="inner_options">' +
					...
					elements : [
						{
							type : 'html',
							id : 'langs',
							html : 	'<form enctype="multipart/form-data" name="languagesbar_' + editorName + '"><div class="inner_langs">' +
									'	<div class="messagebox"></div>	' +
					...
					elements : [
						{
							...
							style: '',
							id : 'dictionaries',
							html : 	'<form enctype="multipart/form-data" name="dictionarybar_' + editorName + '"><div class="inner_dictionary" style="text-align:left; white-space:normal; width:320px; overflow: hidden;">' +
